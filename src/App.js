        ...
        <div className='profile'>
          ...
          <article>
            <h4>프론트엔드에서 저의 상상을 <br/>더욱더 구체적으로 
                코드로 그려 내기위해 
                항상 끊임없이 노력하고 공부 합니다. <br/>
                제가 즐기면서 가장 잘할수있는 웹 퍼블리셔를 시작으로 목표로 하는 프론트엔드개발자 까지 
                더욱더 발전하기 위해 항상 열심히 준비해나가고 있습니다!. <br/> <br/>
                기초가 되는 JavaScript를 꾸준히공부하여 탄탄히 다졌고, 현재 React.js, Redux 강의를 수강완료 
                하여 프로젝트 개발로 계속해서 실력을 향상시키고있습니다.
                좋은 서비스를 만드는 프론트엔드 개발자 로 성장 하기위해 앞으로도 필요한스킬 등을 꾸준히 공부중입니다!.
            </h4>
