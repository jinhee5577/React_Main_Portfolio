export default [
            ...
            {  id : 2,
               explanation : <p><span>영화API</span>를 요청하여 인기영화 20위를 구현하였고, 해당영화의 상세페이지,
                                ...
                                <span>로그인페이지 기능</span>은 간단하게 user정보를 JSON파일로 만들어두어 <span>axios</span>로 요청하였습니다.<br/>
            ...
            {  id : 4,
               explanation : <p><span>React, Localstorage, Redux</span>로 개발된 <span>야나두 TODO_LIST</span> 웹페이지 입니다.<br/>
                            ...
                            작성된 TODO_LIST data를 <span>Localstorage</span>를 이용하여, <span> CRUD기능개발 과 영구저장</span>이 가능합니다. 
                            추가로 Lotto번호를 뽑아주는 페이지를 <span>Javascript와 Redux</span>로 개발하여 페이지 이동간에도 lotto번호 정보가 유효합니다. </p>,
               gitlink : 'https://github.com/jinhee5577/TODO_LIST',     
